class Persona: #se crea clase persona, que funciona parecido a una función
    def __init__(self,nombre, documento): #se crea el el metodo constructor siempre va a pasar por ahí cada vez que se ejecuta el codigo para declarar el constructor se pone el init y el self, posteriormente se le pone un atributo nombre a la clase
